...
Route::group([], function () {
    ...
    // Mobile webview auto-login bridge
    ...
    Route::group(['prefix' => 'payments'], function () {
        ...
        Route::post('/newrequest', 'PaymentsController@paymentnewrequest');
        Route::post('/fmd', 'PaymentsController@fmdpayment');
        ...
        Route::post('/newverify/{gateway}', ['as' => 'payment_verify_post', 'uses' => 'PaymentsController@paymentnewVerify']);
    });
