    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'book'], function () {
            ...
            Route::group(['prefix' => 'categories'], function () {
                ...
                Route::post('/store', 'BookCategoriesController@store');
                Route::get('/{id}/edit', 'BookCategoriesController@edit');
                Route::post('/{id}/update', 'BookCategoriesController@update');
                Route::get('/{id}/delete', 'BookCategoriesController@delete');
            });
        });
