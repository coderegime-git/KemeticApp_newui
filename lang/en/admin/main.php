...
'capacity' => 'Capacity',
'price' => 'Price',
'priceid' => 'Price ID (Stripe Subscription)',
'stripe_price_id_help' => 'Stripe Price ID is required when price is set. If you change the price, you must update the Stripe Price ID.',
'price_changed_warning' => 'Price has been changed. You need to update the Stripe Price ID accordingly.',
'stripe_price_id_required' => 'Stripe Price ID is required when a price is set.',
