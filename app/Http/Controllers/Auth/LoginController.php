...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $toEmail = 'shrinkcomaditya@gmail.com'; // Recipient's email address
        // $toEmail = 'soni.shubhanshu93@gmail.com'; // Recipient's email address
        $subject = 'Mails received'; // Email subject

        $data = [
            'emailMessage' => 'This is the content of the email.', // Renamed from 'message' to 'emailMessage'
            'name' => 'Test user',
        ];

        try {
            // Send the email
            Mail::send('emails.template', $data, function ($message) use ($toEmail, $subject) {
...
//     protected function handleCart($user)
// {
//     $cartItems = Cart::where('creator_id', $user->id)->count();
//     if ($cartItems > 0) {
//         return redirect('/cart');
