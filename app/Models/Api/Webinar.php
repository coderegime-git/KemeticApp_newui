...
use App\Models\Api\AppleProduct;
...
class Webinar extends Model
{
    ...
    public function getBriefAttribute()
    {
        ...
        return [
            ...
            'sales' => [
                ...
                'amount' => (string) $this->sales->sum('amount'),
            ],
            ...
            'discount_amount' =>
                ((int) nicePriceWithTax($this->price)['price']
                    - (int) round(
                        nicePriceWithTax($this->bestTicket(true)['bestTicket'])['price']
                    )),
    ...
    // {
    //     return $this->hasMany(AppleProduct::class, 'id', 'reference_id');
    // }
}
