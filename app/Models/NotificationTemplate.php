...
class NotificationTemplate extends Model
{
    ...
    static $notificationTemplateAssignSetting = [
        'admin' => ['new_comment_admin', 'support_message_admin', 'support_message_replied_admin', 'promotion_plan_admin', 'payout_request_admin',
            ...
            'new_store_order','new_book_order', 'subscription_plan_activated', 'content_review_request', 'new_user_blog_post', 'new_user_item_rating', 'new_organization_user',
        ...
        'plans' => ['new_subscribe_plan', 'promotion_plan','subscripe_plan_cancel'],
        ...
        'book' => ['book_new_sale','book_new_purchase'],
