...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Section::updateOrCreate(['id' => 3132], ['name' => 'admin_giftreel', 'caption' => 'Giftreel']);
        Section::updateOrCreate(['id' => 3133], ['name' => 'admin_giftreel_list', 'section_group_id' => 1000, 'caption' => 'Giftreel list']);
        Section::updateOrCreate(['id' => 3134], ['name' => 'admin_giftreel_create', 'section_group_id' => 1000, 'caption' => 'Giftreel create']);
        Section::updateOrCreate(['id' => 3135], ['name' => 'admin_giftreel_edit', 'section_group_id' => 1000, 'caption' => 'Giftreel edit']);
        Section::updateOrCreate(['id' => 3136], ['name' => 'admin_giftreel_delete', 'section_group_id' => 1000, 'caption' => 'Giftreel delete']);
