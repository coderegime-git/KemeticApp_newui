(function ($) {
  ...
  $('body').off('click', '.js-save-form').on('click', '.js-save-form', function (e) {
    var $this = $(this);
  ...
  $('body').on('click', '.js-view-comment', function (e) {
    ...
    var repliesHtml = '';
    $('.replyDescription' + comment_id).each(function() {
        var replyText = $(this).val();
        var replyUser = $(this).attr('data-user') || '';
        var replyDate = $(this).attr('data-date') || '';
        repliesHtml += '<div class="mt-20 p-15 border border-gray300 bg-info-light rounded-sm"><div class="font-12 text-gray font-weight-bold">' + replyUser + ' - ' + replyDate + '</div><div class="mt-10 text-gray">' + replyText + '</div></div>';
    });

    var html = '<div class="">' + '<h3 class="section-title after-line">' + commentLang + '</h3>' + '<p class="font-weight-500 text-gray mt-20">' + comment + '</p>' + repliesHtml + '</div>';
    Swal.fire({
      html: html,
      showCancelButton: false,
      showConfirmButton: false,
  ...
  $('body').off('click', '.report-comment').on('click', '.report-comment', function (e) {
    e.preventDefault();
    var comment_id = $(this).attr('data-comment-id');
  ...
  $('body').off('click', '#saveReport').on('click', '#saveReport', function (e) {
    var $this = $(this);
