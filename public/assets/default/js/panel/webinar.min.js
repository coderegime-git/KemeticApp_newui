  ...
  (function ($) {
    ...
    $('body').on('click', '#sendForReview', function (e) {
      ...
      if (form && !form.checkValidity()) {
        ...
        $('.js-frontend-invalid').remove();
        $(form).find(':invalid').each(function() {
            $(this).addClass('is-invalid');
            var parent = $(this).closest('.kemetic-input-group');
            var target = parent.length ? parent : $(this);
            if (target.next('.js-frontend-invalid').length === 0) {
                target.after('<div class="js-frontend-invalid text-danger mt-1 font-12">Please fill the required fields</div>');
            }
        });
        return false;
      }
    ...
    * */
    ...
    function setSelect2() {
      ...
      if ($('.accordion-content-wrapper .attachments-select2').length) {
		...
		$('.accordion-content-wrapper .attachments-select2').each(function() {
          var $el = $(this);
