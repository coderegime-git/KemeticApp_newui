...
(function ($) {
  ...
  $('body').on('click', '.add-time', function (e) {
    ...
    var add_time_html = `
      <div class="add-time-modal kemetic-modal p-25 rounded-xl shadow-lg bg-dark">
          <div class="add-time-sheet row flex-column-reverse flex-lg-row align-items-center justify-content-center justify-content-lg-between">
              ...
              <!-- Clock Box -->
              <div class="clock-box col-12 col-lg-4 d-flex align-items-center justify-content-center justify-content-lg-start mb-3 mb-lg-0">
                  <div class="from-clockpicker me-2">
              ...
              <!-- Time Display & AM/PM Switch -->
              <div class="col-12 col-lg-8">
                  <div class="row g-3">
                      <!-- AM/PM Switch -->
                      <div class="col-12 col-lg-4 d-flex align-items-center justify-content-center custom-control custom-switch on-off-switch">
                          <label class="text-gold me-2 fw-bold" style="margin-left:-150px;">AM</label>
                          <input type="checkbox" class="custom-control-input" id="timeTwelveSwitch">
                          <label class="custom-control-label text-gold" for="timeTwelveSwitch">PM</label>
                      </div>

                      <!-- From / To Time -->
                      <div class="col-12 col-lg-8 d-flex flex-column align-items-center justify-content-center">
                          <div class="font-48 text-gold from-time pulsate">03:00 <span class="js-am-pm font-16 text-gray">AM</span></div>
                          <div class="font-weight-500 text-gray small mb-2">To</div>
                          <div class="font-48 text-gold to-time">04:00 <span class="js-am-pm font-16 text-gray">AM</span></div>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="row mt-20">
              <div class="col-12 col-lg-6">
                  <div class="form-group">
                      <label class="input-label text-gold">${meetingTypeLang}</label>
                      <select class="form-control bg-dark text-gold border-gold" name="meeting_type">
          ...
          <div class="form-group mt-3">
              <label class="input-label text-gold">${descriptionLng}</label>
              <textarea name="description" class="form-control bg-dark text-gold border-gold" rows="5" placeholder="${saveTimeDescriptionPlaceholder}"></textarea>
          </div>

          <!-- Action Buttons -->
          <div class="mt-30 d-flex align-items-center justify-content-end" style="padding:10px;">
              <button type="button" data-day="${day}" id="saveTime" class="btn btn-gold btn-sm me-2">${saveLang}</button>
  ...
  $('body').on('submit', '#meetingSettingForm', function (e) {
    e.preventDefault();
    var $form = $(this);
    var $this = $form.find('#meetingSettingFormSubmit');
