...
(function ($) {
  ...
  $('body').off('click', '.js-save-faq').on('click', '.js-save-faq', function (e) {
    e.preventDefault();
    var $this = $(this);
    ...
    $.get('/panel/store/products/specifications/' + specificationId + '/get', function (result) {
      if (result) {
        ...
        if (specification.input_type === 'multi_value') {
          ...
          var select = $form.find('.js-ajax-multi_values');
          select.empty();
          var html = '';
          if (multiValues) {
  ...
  $('body').off('click', '#productAddSpecification').on('click', '#productAddSpecification', function (e) {
    ...
    html = html.replaceAll('search-specification-select2', 'search-specification-select2-' + key);
