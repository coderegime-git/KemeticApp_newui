...
<body class="@if(isset($isMembershipPage) && $isMembershipPage) membership-body @endif @if($isRtl) rtl @endif">
    ...
    <div id="app"
        class="app {{ (!empty($floatingBar) and $floatingBar->position == 'top' and $floatingBar->fixed) ? 'has-fixed-top-floating-bar' : '' }}">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.nav-collapsible-toggle').forEach(toggle => {
                toggle.addEventListener('click', function (e) {
                    ...
                    // Close all other collapsible menus that are not ancestors of this one
                    document.querySelectorAll('.nav-collapsible.open').forEach(other => {
                        if (other !== parent && !other.contains(parent)) {
