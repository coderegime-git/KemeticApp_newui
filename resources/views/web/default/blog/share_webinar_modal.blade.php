<div class="d-none" id="blogShareModal">
    ...
    <div class="text-center">
        ...
        <div class="position-relative d-flex align-items-center justify-content-between p-15 mt-15 border border-gray250 rounded-sm mt-5">
            <div class="js-blog-share-link font-weight-bold px-16 text-ellipsis font-14">{{ url($webinar->getUrl()) }}</div>
        ...
        <div class="mt-32 mt-lg-40 row align-items-center font-14">
            <a href="{{ $webinar->getShareLink('telegram') }}" target="_blank" class="col text-center">
            ...
            <a href="{{ $webinar->getShareLink('whatsapp') }}" target="_blank" class="col text-center">
            ...
            <a href="{{ $webinar->getShareLink('facebook') }}" target="_blank" class="col text-center">
            ...
            <a href="{{ $webinar->getShareLink('twitter') }}" target="_blank" class="col text-center">
