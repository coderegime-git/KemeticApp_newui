...
<div class="d-none" id="webinarNextSessionModal">
    <form action="/panel/sessions/store" method="post">
        ...
        <div class="mt-25">
            ...
            <div class="row">
                <div class="col-12 col-md-7">
                    @if(!empty(getGeneralSettings('content_translate')))
                        <div class="form-group">
                            ...
                            <select name="ajax[new][locale]" class="form-control" data-bundle-id="" data-id=""
                                data-relation="" data-fields="">
                ...
                <div class="col-12 col-md-5">
                    <div class="form-group">
                        <label class="input-label">{{ trans('public.chapter') }} <span
            ...
            <div class="row">
                <div class="col-12 col-md-7">
                    <div class="form-group">
                        <label class="input-label">{{ trans('webinars.session_title') }} <span
                                class="text-danger">*</span></label>
                ...
                <div class="col-12 col-md-5">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="ajax[new][date]" value=""
                                class="js-ajax-date form-control datetimepicker" autocomplete="off" />
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <label class="input-label">{{ trans('public.description') }} <span
                                class="text-danger">*</span></label>
                        <textarea name="ajax[new][description]" class="js-ajax-description form-control"
                            rows="5"></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-6 js-local-link">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <button type="button" class="input-group-text js-copy" data-input="ajax[new][link]"
                                data-bs-toggle="tooltip" data-placement="top" title="{{ trans('public.copy') }}"
                                data-copy-text="{{ trans('public.copy') }}"
                                data-done-text="{{ trans('public.copied') }}">
            ...
            <div class="col-12 col-md-6 js-moderator-secret d-none">
                <div class="form-group">
                    ...
                    <input type="text" name="ajax[new][moderator_secret]" class="js-ajax-moderator_secret form-control"
                        value="" />
                    <div class="invalid-feedback"></div>
                </div>
            </div>
        ...
        <div class="mt-30 d-flex align-items-center justify-content-end" style="padding:10px;">
            <button type="button"
                class="js-save-next-session btn btn-sm btn-primary">{{ trans('public.save') }}</button>
