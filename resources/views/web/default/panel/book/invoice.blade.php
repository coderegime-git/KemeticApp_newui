...
<head>
    ...
    <title>{{ $pageTitle ?? 'Kemetic Book Invoice' }} </title>
                        ...
                        <div class="invoice">
                            <div class="invoice-print">
                                ...
                                <div class="invoice-title mb-4">
                                    ...
                                    <div class="invoice-number">{{ trans('public.order') }} ID: #{{ $order->id }}</div>
                                </div>
                                ...
                                <div class="table-responsive mb-4">
                                    <table class="table table-striped table-hover table-md text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    {{ $book->title ?? trans('update.delete_item') }}
                                                </td>
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-6 text-left">
                                        <div class="invoice-detail-item">
                                            ...
                                            <div class="invoice-detail-value">{{ $book->title ?? trans('update.delete_item') }}</div>
                                        </div>
