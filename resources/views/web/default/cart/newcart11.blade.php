                    ...
                    <select id="dummy_country_id" name="dummy_country_id" class="ck-input">
                      ...
                      @if(!empty($countries))
                        @foreach($countries as $country)
                          @php
                            $savedCountry = session('ck_dummy_country');
                            $isSelected = $savedCountry
                              ? ($savedCountry == $country->id)
                              : (stripos($country->title, 'Netherlands') !== false);
                          @endphp
                ...
                <section class="ck-section">
                  ...
                  <div class="ck-row">
                    <div class="ck-field">
                      ...
                      <div class="ck-invalid ck-client-error" id="error-firstName"
                        style="display:none; color:var(--ck-danger);">Please fill
                        required fields</div>
                    ...
                    <div class="ck-field">
                      ...
                      <div class="ck-invalid ck-client-error" id="error-lastName"
                        style="display:none; color:var(--ck-danger);">Please fill required
                        fields</div>
                  ...
                  <div class="ck-field">
                    ...
                    <div class="ck-invalid ck-client-error" id="error-email" style="display:none; color:var(--ck-danger);">
                  ...
                  <div class="ck-field">
                    ...
                    <input id="phone" name="phone" type="text" class="ck-input @error('phone') is-invalid @enderror"
                      required min-length="6" maxlength="15"
                    ...
                    <div class="ck-invalid ck-client-error" id="error-phone" style="display:none; color:var(--ck-danger);">
                      Please fill required
                      fields</div>
              ...
              <div>
                <section class="ck-section">
                  ...
                  <div class="ck-field">
                    ...
                    <div class="ck-invalid ck-client-error" id="error-shipping_country"
                      style="display:none; color:var(--ck-danger);">Please fill
                      required fields</div>
                    @error('country_id')<div class="ck-invalid" style="color:var(--ck-danger);">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="ck-row">
                    <div class="ck-field">
                      ...
                      <div class="ck-invalid ck-client-error" id="error-province"
                        style="display:none; color:var(--ck-danger);">Please fill required
                        fields</div>
                      @error('province_name')<div class="ck-invalid" style="color:var(--ck-danger);">{{ $message }}</div>
                      @enderror
                    </div>
                    <div class="ck-field">
                      ...
                      <div class="ck-invalid ck-client-error" id="error-city" style="display:none; color:var(--ck-danger);">
                        Please fill required
                        fields</div>
                      @error('city_name')<div class="ck-invalid" style="color:var(--ck-danger);">{{ $message }}</div>
                      @enderror
                    </div>
                  </div>
                  ...
                  <div class="ck-field">
                    ...
                    <div class="ck-invalid ck-client-error" id="error-house_no"
                      style="display:none; color:var(--ck-danger);">Please fill required
                      fields</div>
                  ...
                  <div class="ck-field">
                    ...
                    <div class="ck-invalid ck-client-error" id="error-address"
                      style="display:none; color:var(--ck-danger);">Please fill required
                      fields</div>
                  ...
                  <div class="ck-field">
                    ...
                    <div class="ck-invalid ck-client-error" id="error-zip" style="display:none; color:var(--ck-danger);">
                ...
                <section class="ck-section" id="billingSection">
                  ...
                  <div id="billingFields" style="display:none;">
                    ...
                    <div class="ck-field">
                      ...
                      <input id="billing_zip" name="billing_zip" type="text" class="ck-input" maxlength="10"
              ...
              <div>
                ...
                <section class="ck-section">
                  ...
                  <label style="display:flex; align-items:center; gap:10px; margin-bottom:12px; cursor:pointer;">
                    ...
                    <span style="font-size:14px; color:var(--ck-text);">I agree to the <a href="/pages/Terms-and-Conditions"
                        target="_blank" style="color:var(--ck-gold);">Terms & Conditions</a>.</span>
                  </label>
                  <label style="display:flex; align-items:center; gap:10px; margin-bottom:12px; cursor:pointer;">
                    <input type="checkbox" class="legal-checkbox" required style="width:18px;height:18px;">
                    <span style="font-size:14px; color:var(--ck-text);">I understand the <a href="/pages/refund-policy"
...
@push('scripts_bottom')
  <script>
      ...
      fetch('https://v6.exchangerate-api.com/v6/' + apiKey + '/latest/EUR')
        ...
        .then(function (data) {
          if (data && data.result === 'success' && data.conversion_rates) {
            /* Update only currencies that exist in our system */
            for (var c in currencyRates) {
              if (data.conversion_rates[c]) {
                currencyRates[c] = data.conversion_rates[c];
              }
            }
            /* EUR is always base = 1 (never overridden) */
            currencyRates['EUR'] = 1;
            /* Apply live rates to ALL steps simultaneously */
            updateDomTotals();
          }
        })
        .catch(function (err) {
          /* API failed — DB table rates already in use, no action needed */
          console.warn('Exchange API unavailable, using table rates.', err);
        });
    }
    var currencySymbols = {
      @foreach($currencies as $c)
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      /* PHP already rendered correct prices. Live rates update will fire from API below. */
    });
    ...
    function updateDomTotals() {
      // Update the main subtotals and totals
      ...
      // Update the individual cart items so they add up correctly
      document.querySelectorAll('.cart-item-unit-price').forEach(function (el) {
        var base = parseFloat(el.getAttribute('data-base')) || 0;
        el.textContent = formatMoney(base);
      });
      document.querySelectorAll('.cart-item-line-total').forEach(function (el) {
        var base = parseFloat(el.getAttribute('data-base')) || 0;
        el.textContent = formatMoney(base);
      });
    }
      ...
      if (nextBtn4) {
        nextBtn4.addEventListener('click', function () {
          ...
          if (!allChecked) {
            ...
            var toastMsg = document.getElementById('ckToastMsg');
            if (toast) {
              toastMsg.textContent = 'Please check all three boxes in the Legal Confirmation section.';
              toast.classList.add('show');
          ...
          fetch('/cart/checkout', {
            ...
            if (data && data.order_id) {
              ...
              if (orderInput) {
                ...
                hid.type = 'hidden';
                hid.name = 'order_id';
                hid.value = data.order_id;
                form.appendChild(hid);
              }

              // Clear sessionStorage on submit so next purchase starts fresh
              try { sessionStorage.removeItem('ck_order_id'); } catch (e) { }
              try { sessionStorage.removeItem('ck_dummy_country_id'); } catch (e) { }
              // Set flag to detect if user clicks browser back from Stripe
              try { sessionStorage.setItem('ck_went_to_stripe', data.order_id); } catch (e) { }

              // Pass live-rate amount + currency so Stripe shows the SAME price the user sees
              ...
              // Now submit the form for payment
              ...
              showToast('Checkout failed. Please check your details.');
            }
          }).catch(err => {
            console.error(err);
            btn.innerHTML = originalText;
        ...
        try {
          ...
          if (wentToStripe) {
            sessionStorage.removeItem('ck_went_to_stripe');
             sessionStorage.removeItem('ck_dummy_country_id');
            
            // Only redirect if the user actually clicked the browser's back button to get here
