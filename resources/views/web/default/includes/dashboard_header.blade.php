...
<aside class="dashboard-side">
    <div class="dashboard-brand">
        <div class="dashboard-brand-badge">
            @if(auth()->user())
                <img src="{{ $authUser->getAvatar(50) }}" class="img-cover rounded-circle" alt="{{ $authUser->full_name }}"
                    width="50" onerror="this.src='https://placehold.co/40x40?text=K'">
            @endif
        </div>
        <div>
    ...
    <nav class="dashboard-nav">
        <!-- Dashboard -->
        <a href="/"
            style="display:flex; align-items:center; gap:50px; padding:13px 16px; color:var(--sidebar-text); text-decoration:none; border-radius:12px; margin-bottom:6px; transition:all .25s ease;"><span
                class="dashboard-ms">home</span> Home</a>
        @if(auth()->user())
            <a href="/panel"
                style="display:flex; align-items:center; gap:40px; padding:13px 16px; color:var(--sidebar-text); text-decoration:none; border-radius:12px; margin-bottom:6px; transition:all .25s ease;"
            ...
            <a href="{{ route('reels.index') }}"
                style="display:flex; align-items:center; gap:50px; padding:13px 16px; color:var(--sidebar-text); text-decoration:none; border-radius:12px; margin-bottom:6px; transition:all .25s ease;"
                ...
                <div class="nav-collapsible-content">
                        ...
                        @if($authUser->isOrganization() || $authUser->isTeacher())
                            ...
                            @can('panel_webinars_lists')
                                <a href="/panel/webinars"
                                    class="{{ Request::is('panel/webinars') && !Request::is('panel/webinars/*') ? 'active' : '' }}">
                                    <span class="dashboard-ms">list</span> {{ trans('panel.my_classes') }}
                                </a>
                            @endcan
                            @can('panel_webinars_invited_lists')
                                <a href="/panel/webinars/invitations"
                                    class="{{ Request::is('panel/webinars/invitations') ? 'active' : '' }}">
                    ...
                    @if(!empty($authUser->organ_id))
                        @can('panel_webinars_organization_classes')
                            <a href="/panel/webinars/organization_classes"
                                class="{{ Request::is('panel/webinars/organization_classes') ? 'active' : '' }}">
                    ...
                    @can('panel_webinars_my_purchases')
                        <a href="/panel/webinars/purchases"
                            class="{{ Request::is('panel/webinars/purchases') ? 'active' : '' }}">
                    ...
                    @can('panel_webinars_comments')
                        <a href="/panel/webinars/my-comments"
                            class="{{ Request::is('panel/webinars/my-comments') ? 'active' : '' }}">
                    ...
                    @if(!empty(getFeaturesSettings('course_notes_status')))
                        @can('panel_webinars_personal_course_notes')
                            <a href="/panel/webinars/personal-notes"
                                class="{{ Request::is('panel/webinars/personal-notes') ? 'active' : '' }}">
                ...
                <div class="nav-collapsible {{ Request::is('panel/assignments*') ? 'open' : '' }}">
                    ...
                    <div class="nav-collapsible-content">
                        @can('panel_assignments_lists')
                            <a href="/panel/assignments/my-assignments"
                                class="{{ Request::is('panel/assignments/my-assignments') ? 'active' : '' }}">
                                <span class="dashboard-ms">assignment</span> {{ trans('update.my_assignments') }}
                            </a>
                        @endcan
                        @if($authUser->isOrganization() || $authUser->isTeacher())
                            @can('panel_assignments_my_courses_assignments')
                                <a href="/panel/assignments/my-courses-assignments"
                                    class="{{ Request::is('panel/assignments/my-courses-assignments') ? 'active' : '' }}">
                    ...
                    <div class="nav-collapsible-content">
                        @if($authUser->isOrganization() || $authUser->isTeacher())
                            @can('panel_upcoming_courses_create')
                                <a href="/panel/upcoming_courses/new"
                                    class="{{ Request::is('panel/upcoming_courses/new') ? 'active' : '' }}">
                                    <span class="dashboard-ms">add_circle</span> {{ trans('public.new') }}
                                </a>
                            @endcan
                            @can('panel_upcoming_courses_lists')
                                <a href="/panel/upcoming_courses"
                                    class="{{ Request::is('panel/upcoming_courses') && !Request::is('panel/upcoming_courses/*') ? 'active' : '' }}">
                                    <span class="dashboard-ms">list</span> {{ trans('update.my_upcoming_courses') }}
                                </a>
                            @endcan
                        @endif
                        @can('panel_upcoming_courses_followings')
                            <a href="/panel/upcoming_courses/followings"
                                class="{{ Request::is('panel/upcoming_courses/followings') ? 'active' : '' }}">
            ...
            <div class="nav-collapsible {{ Request::is('panel/quizzes*') ? 'open' : '' }}">
                ...
                <div class="nav-collapsible-content">
                    @if($authUser->isOrganization() || $authUser->isTeacher())
                        ...
                        @can('panel_quizzes_lists')
                            <a href="/panel/quizzes"
                                class="{{ Request::is('panel/quizzes') && !Request::is('panel/quizzes/*') ? 'active' : '' }}">
                    ...
                    @can('panel_quizzes_my_results')
                        <a href="/panel/quizzes/my-results"
                            class="{{ Request::is('panel/quizzes/my-results') ? 'active' : '' }}">
                    ...
                    <div class="nav-collapsible-content">
                        @if($authUser->isOrganization() || $authUser->isTeacher())
                            @can('panel_certificates_lists')
                                <a href="/panel/certificates"
                                    class="{{ Request::is('panel/certificates') && !Request::is('panel/certificates/*') ? 'active' : '' }}">
                                    <span class="dashboard-ms">list</span> {{ trans('public.list') }}
                                </a>
                            @endcan
                        @endif
                        @can('panel_certificates_achievements')
                            <a href="/panel/certificates/achievements"
                                class="{{ Request::is('panel/certificates/achievements') ? 'active' : '' }}">
                        ...
                        @can('panel_certificates_course_certificates')
                            <a href="/panel/certificates/webinars"
                                class="{{ Request::is('panel/certificates/webinars') ? 'active' : '' }}">
            ...
            <div class="nav-collapsible {{ Request::is('panel/meetings*') ? 'open' : '' }}">
                ...
                <div class="nav-collapsible-content">
                    @can('panel_meetings_my_reservation')
                        <a href="/panel/meetings/reservation"
                            class="{{ Request::is('panel/meetings/reservation') ? 'active' : '' }}">
                ...
                <div class="nav-collapsible-content">
                    ...
                    @if($authUser->isTeacher())
                        @can('panel_products_create')
                            <a href="/panel/store/products/new"
                                class="{{ Request::is('panel/store/products/new') ? 'active' : '' }}">
                                <span class="dashboard-ms">add_circle</span>Own Product
                            </a>
                        @endcan

                        <div class="nav-collapsible nav-sub-collapsible {{ (request()->is('panel/cj-products') or request()->is('panel/cj/*')) ? 'open' : '' }}"
                            data-sub="true">
                            <a
                                class="nav-collapsible-toggle {{ (request()->is('panel/cj-products') or request()->is('panel/cj/*')) ? 'active' : '' }}">
                    ...
                    @if($authUser->isOrganization() || $authUser->isTeacher())
                        ...
                        @can('panel_products_lists')
                            <a href="/panel/store/products"
                                class="{{ Request::is('panel/store/products') && !Request::is('panel/store/products/*') ? 'active' : '' }}">
                    ...
                    @if($authUser->isOrganization() || $authUser->isTeacher())
                        @can('panel_products_comments')
                            <a href="/panel/store/products/comments"
                                class="{{ Request::is('panel/store/products/comments') ? 'active' : '' }}">
                                <span class="dashboard-ms">comment</span> {{ trans('update.product_comments') }}
                            </a>
                        @endcan
                    @endif
                    @can('panel_products_my_comments')
                        <a href="/panel/store/products/my-comments"
                            class="{{ Request::is('panel/store/products/my-comments') ? 'active' : '' }}">
                            <span class="dashboard-ms">forum</span> {{ trans('panel.my_comments') }}
                        </a>
                    @endcan
                </div>
            ...
            <div class="nav-collapsible {{ Request::is('panel/financial*') ? 'open' : '' }}">
                ...
                <div class="nav-collapsible-content">
                    ...
                    @can('panel_financial_subscribes')
                        <a href="/panel/financial/subscribes"
                            class="{{ Request::is('panel/financial/subscribes') ? 'active' : '' }}">
                    ...
                    @if(($authUser->isOrganization() || $authUser->isTeacher()) and getRegistrationPackagesGeneralSettings('status'))
                        @can("panel_financial_registration_packages")
                            <a href="{{ route('panelRegistrationPackagesLists') }}"
                                class="{{ Request::is('panel/financial/registration-packages') ? 'active' : '' }}">
                    ...
                    @if(getInstallmentsSettings('status'))
                        @can('panel_financial_installments')
                            <a href="/panel/financial/installments"
                                class="{{ Request::is('panel/financial/installments*') ? 'active' : '' }}">
            ...
            @if($authUser->isOrganization())
                <div class="nav-section">
                    ...
                    @can('panel_organization_students')
                        <div
                            class="nav-collapsible {{ Request::is('panel/students*') || Request::is('panel/manage/students*') ? 'open' : '' }}">
                            <a
                                class="nav-collapsible-toggle {{ Request::is('panel/students*') || Request::is('panel/manage/students*') ? 'active' : '' }}">
                            ...
                            <div class="nav-collapsible-content">
                                @can('panel_organization_students_create')
                                    <a href="/panel/manage/students/new"
                                        class="{{ Request::is('panel/manage/students/new') ? 'active' : '' }}">
                    ...
                    @can('panel_organization_instructors')
                        <div
                            class="nav-collapsible {{ Request::is('panel/instructors*') || Request::is('panel/manage/instructors*') ? 'open' : '' }}">
                            <a
                                class="nav-collapsible-toggle {{ Request::is('panel/instructors*') || Request::is('panel/manage/instructors*') ? 'active' : '' }}">
                            ...
                            <div class="nav-collapsible-content">
                                @can('panel_organization_instructors_create')
                                    <a href="/panel/manage/instructors/new"
                                        class="{{ Request::is('panel/instructors/new') ? 'active' : '' }}">
                                        <span class="dashboard-ms">person_add</span> {{ trans('public.new') }}
                                    </a>
                                @endcan
                                @can('panel_organization_instructors_lists')
                                    <a href="/panel/manage/instructors"
                                        class="{{ Request::is('panel/manage/instructors') ? 'active' : '' }}">
                                        <span class="dashboard-ms">list</span> {{ trans('public.list') }}
                                    </a>
                                @endcan
                            </div>
                ...
                <div class="nav-collapsible-content">
                    ...
                    @can('panel_support_lists')
                        <a href="/panel/support"
                            class="{{ Request::is('panel/support') && !Request::is('panel/support/*') ? 'active' : '' }}">
                        ...
                        <div class="nav-collapsible-content">
                            @if(!$authUser->isUser())
                                @can('panel_marketing_special_offers')
                                    <a href="/panel/marketing/special_offers"
                                        class="{{ Request::is('panel/marketing/special_offers') ? 'active' : '' }}">
                                        <span class="dashboard-ms">campaign</span> {{ trans('panel.discounts') }}
                                    </a>
                                @endcan
                                @can('panel_marketing_promotions')
                                    <a href="/panel/marketing/promotions"
                                        class="{{ Request::is('panel/marketing/promotions') ? 'active' : '' }}">
                            ...
                            @if(!empty($referralSettings) and $referralSettings['status'] and $authUser->affiliate)
                                @can('panel_marketing_affiliates')
                                    <a href="/panel/marketing/affiliates"
                                        class="{{ Request::is('panel/marketing/affiliates') ? 'active' : '' }}">
                            ...
                            @if(!empty(getRegistrationBonusSettings('status')) and $authUser->enable_registration_bonus)
                                @can('panel_marketing_registration_bonus')
                                    <a href="/panel/marketing/registration_bonus"
                                        class="{{ Request::is('panel/marketing/registration_bonus') ? 'active' : '' }}">
                            ...
                            @if(!empty(getFeaturesSettings('frontend_coupons_status')))
                                @can('panel_marketing_coupons')
                                    <a href="/panel/marketing/discounts"
                                        class="{{ Request::is('panel/marketing/discounts') ? 'active' : '' }}">
                                        <span class="dashboard-ms">local_offer</span> {{ trans('update.coupons') }}
                                    </a>
                                @endcan
                                @can('panel_marketing_new_coupon')
                                    <a href="/panel/marketing/discounts/new"
                                        class="{{ Request::is('panel/marketing/discounts/new') ? 'active' : '' }}">
        ...
        @if(getFeaturesSettings('forums_status'))
            @can('panel_forums')
                <div
                    class="nav-collapsible {{ Request::is('panel/forums*') || Request::is('forums/create-topic') ? 'open' : '' }}">
                    <a
                        class="nav-collapsible-toggle {{ Request::is('panel/forums*') || Request::is('forums/create-topic') ? 'active' : '' }}">
        ...
        @if(auth()->user())
            @if($authUser->isTeacher())
                @can('panel_blog')
                    <div class="nav-collapsible {{ (request()->is('panel/blog') or request()->is('panel/blog/*')) ? 'open' : '' }}">
                        <a
                            class="nav-collapsible-toggle {{ (request()->is('panel/blog') or request()->is('panel/blog/*')) ? 'active' : '' }}">
            ...
            @if($authUser->isOrganization() || $authUser->isTeacher())
                @can('panel_noticeboard')
                    <div
                        class="nav-collapsible {{ (request()->is('panel/noticeboard*') or request()->is('panel/course-noticeboard*')) ? 'open' : '' }}">
                        <a
                            class="nav-collapsible-toggle {{ (request()->is('panel/noticeboard*') or request()->is('panel/course-noticeboard*')) ? 'active' : '' }}">
                        ...
                        <div class="nav-collapsible-content">
                            ...
                            @can('panel_noticeboard_course_notices')
                                <a href="/panel/course-noticeboard"
                                    class="{{ (request()->is('panel/course-noticeboard')) ? 'active' : '' }}">
                            ...
                            @can('panel_noticeboard_course_notices_create')
                                <a href="/panel/course-noticeboard/new"
                                    class="{{ (request()->is('panel/course-noticeboard/new')) ? 'active' : '' }}">
            ...
            @if(!empty($rewardSetting) and $rewardSetting['status'] == '1')
                @can('panel_rewards')
                    <a href="/panel/rewards"
                        style="display:flex; align-items:center; gap:30px; padding:13px 16px; color:var(--sidebar-text); text-decoration:none; border-radius:12px; margin-bottom:6px; transition:all .25s ease;"
            ...
            @if($authUser->checkAccessToAIContentFeature())
                @can('panel_ai_contents')
                    <div class="nav-collapsible {{ (request()->is('panel/ai-contents')) ? 'open' : '' }}">
                        <a href="/panel/ai-contents"
                            class="nav-collapsible-toggle {{ (request()->is('panel/ai-contents')) ? 'active' : '' }}">
    ...
    <div style="margin-top:auto">
        <div class="dashboard-chakra">
            <i style="background:var(--red)"></i><i style="background:var(--orange)"></i><i
                style="background:var(--yellow)"></i>
            <i style="background:var(--green)"></i><i style="background:var(--blue)"></i><i
                style="background:var(--indigo)"></i><i style="background:var(--violet)"></i>
        </div>
    </div>
</aside>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (nav && active) {
            var collapsible = active.closest('.nav-collapsible');
            var target = collapsible ? collapsible : active;
            var targetTop = target.offsetTop;
            // Scroll nav to center the target
            nav.scrollTop = targetTop - (nav.clientHeight / 2) + (target.clientHeight / 2);
        }
    });
</script>