    ...
    <div class="mt-20">
        <form action="/comments/store" method="post">
            ...
            <div class="form-group">
                <textarea name="comment" class="form-control {{ isset($errors) && $errors->has('comment') ? 'is-invalid' : '' }}" rows="10"></textarea>
                <div class="invalid-feedback">{{ isset($errors) &&  $errors->has('comment') ? $message : '' }}</div>
            </div>
