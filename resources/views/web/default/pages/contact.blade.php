                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control @if(isset($errors) && ($errors->has('name')))  is-invalid @endif"/>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="email" value="{{ old('email') }}" class="form-control @if(isset($errors) && ($errors->has('email')))  is-invalid @endif"/>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" value="{{ old('phone') }}" class="form-control  @if(isset($errors) && ($errors->has('phone'))) is-invalid @endif"/>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" value="{{ old('subject') }}" class="form-control @if(isset($errors) && ($errors->has('subject'))) is-invalid @endif"/>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="message" id="" rows="10" class="form-control @if(isset($errors) && ($errors->has('message'))) is-invalid @endif">{{ old('message') }}</textarea>
