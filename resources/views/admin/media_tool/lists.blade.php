...
<section class="section">
    <div class="section-header">
        <h1>{{trans('admin/main.media_tools')}}</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ getAdminPanelUrl() }}">{{trans('admin/main.dashboard')}}</a>
            </div>
            <div class="breadcrumb-item">{{trans('admin/main.media_tools')}}</div>
        </div>
    </div>
            ...
            <div class="card-body overflow-auto">
                <table class="table table-striped font-14" id="datatable-details">
                    ...
                    <tr>
                        ...
                        <th class="text-left">{{trans('admin/main.link')}}</th>
                        <th class="">{{trans('admin/main.icon')}}</th>
                    ...
                    <tr>
                        ...
                        <td class="" width="50">
                            @can('admin_reviews_status_toggle')
                                <a href="{{ getAdminPanelUrl() }}/media-tools/{{ $media->id }}/toggleStatus" class="btn-transparent text-primary mr-1" data-toggle="tooltip" data-placement="top" title="{{ ($media->status == 'active') ? 'Hidden' : 'Publish' }}">
                                    @if($media->status == 'active')
                            ...
                            @can('admin_reviews_delete')
                                <form action="{{ getAdminPanelUrl() }}/media-tools/{{ $media->id }}/delete" method="POST" class="d-inline delete-form">
                                    @csrf
                                    @method('DELETE')
